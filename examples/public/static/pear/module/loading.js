layui.define([
    ...
    var confirmSettings = {
        ...
        width               : "300px",
        zindex              : 4003,
        position            : "center", // 'center' - 'center-top' -  'right-top' - 'right-bottom' - 'left-top' -
                                        // 'left-bottom'
        distance            : "10px",
        backgroundColor     : "#f8f8f8",
        borderRadius        : "25px",
    ...
    var NotiflixNotify      = function (message, callback, theType, staticType) {
        if (arguments && arguments.length === 4)
        {
            ...
            if (!newNotifySettings.plainText && message.length > newNotifySettings.messageMaxLength)
            {
                ...
                message = "<b>HTML Tags Error:</b> Your content length is more than \"messageMaxLength\" option."; // message
                                                                                                                 // html
                                                                                                                 // error
            }
    ...
    var NotiflixReport = function (title, message, buttonText, buttonCallback, theType, staticType) {
        ...
        if (!newReportSettings.plainText)
        {
            ...
            {
                title      = "HTML Tags Error"; // title html error
                message    = "Your Message content length is more than \"messageMaxLength\" option."; // message html
                                                                                                    // error
                buttonText = "Okay"; // button html error
            }
    ...
    var NotiflixConfirm = function (title, message, okButtonText, cancelButtonText, okButtonCallback, cancelButtonCallback) {
        ...
        if (!newConfirmSettings.plainText)
        {
            ...
            {
                title            = "HTML Tags Error"; // title html error
                message          = "Your Title content length is more than \"titleMaxLength\" option."; // message html
                                                                                                      // error
            ...
            {
                title            = "HTML Tags Error"; // title html error
                message          = "Your Message content length is more than \"messageMaxLength\" option."; // message
                                                                                                          // html error
                okButtonText     = "Okay"; // button html error
                cancelButtonText = "..."; // button html error
            }
            ...
            {
                title            = "HTML Tags Error"; // title html error
                message          = "Your Buttons contents length is more than \"buttonsMaxLength\" option."; // message
                                                                                                           // html
                                                                                                           // error
                okButtonText     = "Okay"; // button html error
                cancelButtonText = "..."; // button html error
